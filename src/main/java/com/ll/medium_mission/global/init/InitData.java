...
public class InitData {
    ...
    static final String FAQContent = """
                ...
                이러한 가이드라인을 따르면 좋은 글을 쓰는 데 도움이 될 것입니다.
                물론, 글쓰기는 연습이 필요한 작업이므로 꾸준한 노력과 피드백을 통해 습관화하는 것이 중요합니다.
    ...
    static final String TipContent = """
            ...
            위의 팁을 활용하면 사람들이 읽고 싶어하는 에세이를 작성할 수 있을 것입니다.
            또한, 글 작성은 계속해서 연습과 피드백을 통해 개선해 나가야 하는 과정이므로 꾸준한 노력과 열정을 가지고 도전해 보시기 바랍니다.
            좋은 결과를 기대해 봅니다!
            """;
